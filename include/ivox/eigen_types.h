...
/// implementation
template <>
inline bool LessVec<2>::operator()(
...
template <>
inline bool LessVec<3>::operator()(
...
template <>
inline size_t HashVec<2>::operator()(const Eigen::Matrix<int, 2, 1> & v) const
{
...
/// vec 3 hash
template <>
inline size_t HashVec<3>::operator()(const Eigen::Matrix<int, 3, 1> & v) const
{
